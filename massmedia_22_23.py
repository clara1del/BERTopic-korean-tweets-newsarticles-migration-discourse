...
model.save('massmedia2022_2023.h5')
...
fig.write_html("22_23massjunenewsbarchart.html")
fig.show()


fig = model.visualize_topics()
fig.write_html("22_23massjunenewstopics.html")
fig.show()


fig = model.visualize_hierarchy()
fig.write_html("22_23massjunenewshierarchy.html")
fig.show()


fig = model.visualize_heatmap()
fig.write_html("22_23massjunenewsheatmap.html")
fig.show()


fig = model.visualize_term_rank()
fig.write_html("22_23massjunenewstermrank.html")
fig.show()


fig = model.visualize_term_rank(log_scale=True)
fig.write_html("22_23massjunenewslogtermrank.html")
fig.show()

#junemassmedia2022_2023news
# %%

topics_over_time = model.topics_over_time(documents, timestamps)
fig = model.visualize_topics_over_time(topics_over_time)
fig.write_html("22_23massjunenewstopicstime.html")
fig.show()
