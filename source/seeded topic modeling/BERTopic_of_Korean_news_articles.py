...
fig.write_html("massmedia2009_2023junenewsbarchart.html")
fig.show()


fig = model.visualize_topics()
fig.write_html("massmedia2009_2023junenewstopics.html")
fig.show()


fig = model.visualize_hierarchy()
fig.write_html("massmedia2009_2023junenewshierarchy.html")
fig.show()


fig = model.visualize_heatmap()
fig.write_html("massmedia2009_2023junenewsheatmap.html")
fig.show()


fig = model.visualize_term_rank()
fig.write_html("massmedia2009_2023junenewstermrank.html")
fig.show()
