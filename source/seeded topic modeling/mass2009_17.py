...
model.save('massmedia2009_2017.h5')
...
fig.write_html("media2009_2017junenewsbarchart.html")
fig.show()


fig = model.visualize_topics()
fig.write_html("media2009_2017junenewstopics.html")
fig.show()


fig = model.visualize_hierarchy()
fig.write_html("media2009_2017junenewshierarchy.html")
fig.show()


fig = model.visualize_heatmap()
fig.write_html("media2009_2017junenewsheatmap.html")
fig.show()


fig = model.visualize_term_rank()
fig.write_html("media2009_2017junenewstermrank.html")
fig.show()


fig = model.visualize_term_rank(log_scale=True)
fig.write_html("media2009_2017junenewslogtermrank.html")
fig.show()

#junemassmedia2009_2017news
# %%

topics_over_time = model.topics_over_time(documents, timestamps)
fig = model.visualize_topics_over_time(topics_over_time)
fig.write_html("media2009_2017junenewstopicstime.html")
fig.show()
